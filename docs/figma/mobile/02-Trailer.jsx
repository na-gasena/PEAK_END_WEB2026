...
[https://youtu.be/lBZiY2sbzI0](https://youtu.be/lBZiY2sbzI0)" data-name="Video_YouTube" data-node-id="2034:2574"><img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgVideoYouTube}/></div><SectionHeading className="-translate-x-1/2 absolute bg-[var(--heading,#fefefe)] content-stretch flex items-center justify-center left-[calc(50%+0.5px)] px-[18px] py-[12px] top-[13px]"/></div>);
}
